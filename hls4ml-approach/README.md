...
2. Install XRT and the platforms according to the instructions provided in the Xilinx user guide UG1301 version 1.3 [here](https://docs.xilinx.com/v/u/2.0-English/ug1301-getting-started-guide-alveo-accelerator-cards).
